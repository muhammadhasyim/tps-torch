...
bp_sampler = BrownianParticle(dt=2e-3,gamma=1.0,kT=0.5,initial = initial_config,prefix=prefix)
...
optimizer = EXPReweightSGD(committor.parameters(), lr=0.2, momentum=0.9)
