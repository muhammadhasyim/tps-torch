...
void export_DimerFTS(py::module& m)
{
    ...
    .def("getBondLengthConfig", &DimerFTS::getBondLengthConfig)
...
void export_DimerEXP(py::module& m)
{
    ...
    .def("dumpRestart", &DimerEXP::dumpRestart)
    .def("useRestart", &DimerEXP::useRestart)
...
void export_DimerEXPString(py::module& m)
{
    ...
    .def("dumpRestart", &DimerEXPString::dumpRestart)
    .def("useRestart", &DimerEXPString::useRestart)
