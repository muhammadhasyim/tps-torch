...
set(TPSTORCH_ML_LIB ${TPSTORCH_ROOT}/ml/_ml${PYTHON_MODULE_EXTENSION})
set(TPSTORCH_SM_LIB ${TPSTORCH_ROOT}/sm/_sm${PYTHON_MODULE_EXTENSION})
set(TPSTORCH_LIBRARIES ${TPSTORCH_LIB} ${TPSTORCH_FTS_LIB} ${TPSTORCH_ML_LIB} ${TPSTORCH_SM_LIB})
